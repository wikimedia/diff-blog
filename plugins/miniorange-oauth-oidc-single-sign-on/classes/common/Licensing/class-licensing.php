...
class Licensing
{
    ...
    public static function show_licensing_page()
    {
        ...
        echo $NQ->mo_oauth_is_customer_registered();
        ?>
" id="mo_customer_registered">
        <form style="display:none;" id="loginform"
                    action="<?php 
        echo $NQ->mo_oauth_client_get_option("\x68\157\163\x74\x5f\156\x61\x6d\x65") . "\x2f\155\x6f\x61\163\x2f\154\157\x67\x69\x6e";
        ?>
"
                    target="_blank" method="post">
            <input type="email" name="username" value="<?php 
        echo $NQ->mo_oauth_client_get_option("\x6d\x6f\137\157\x61\165\164\150\x5f\x61\x64\x6d\x69\x6e\137\x65\x6d\x61\x69\x6c");
        ?>
"/>
            <input type="text" name="redirectUrl"
                value="<?php 
        echo $NQ->mo_oauth_client_get_option("\150\157\163\164\x5f\156\141\x6d\x65") . "\57\155\157\141\163\x2f\x69\x6e\151\x74\x69\x61\154\x69\x7a\x65\160\x61\171\x6d\x65\x6e\x74";
        ?>
"/>
        ...
        <form style="display:none;" id="viewlicensekeys"
                    action="<?php 
        echo $NQ->mo_oauth_client_get_option("\x68\x6f\163\164\x5f\156\x61\x6d\x65") . "\x2f\x6d\x6f\x61\163\57\x6c\157\147\151\156";
        ?>
"
                    target="_blank" method="post">
            <input type="email" name="username" value="<?php 
        echo $NQ->mo_oauth_client_get_option("\155\157\137\x6f\141\165\164\x68\x5f\141\x64\x6d\151\156\x5f\145\155\x61\151\154");
        ?>
"/>
            <input type="text" name="redirectUrl"
                value="<?php 
        echo $NQ->mo_oauth_client_get_option("\150\157\x73\164\x5f\x6e\141\155\145") . "\57\155\157\x61\x73\57\166\151\145\167\154\x69\143\x65\x6e\163\145\153\145\171\x73";
        ?>
"/>
        </form>
        ...
        echo add_query_arg(array("\164\x61\142" => "\x61\143\x63\157\x75\x6e\164"), htmlentities($_SERVER["\x52\x45\121\x55\105\x53\x54\x5f\x55\x52\111"]));
        ?>
">Back</a>
        <!-- JSForms Controllers -->
        <script>
